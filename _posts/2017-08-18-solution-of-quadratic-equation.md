...
제곱해서 a가 되는 숫자 중에 양수를 $$ \sqrt{a} $$로 쓰기로 **약속**했습니다. 더 이상 토를 달 여지가 없어요. 
...
여기서 만약 $$x$$를 구하라고 한다면?  
헛갈리지 마세요. 저기서 $$x$$는 **제곱을 해서 $$a$$가 되는 수**입니다.~~제곱을 해서 a가 되는 수 중에 양수가 아니에요~~ $$\sqrt{a}$$의 뜻이 **제곱을 해서 $$a$$가 되는 수 중에 양수**이므로, $$x$$는 그런 숫자 하나랑 그 반대부호를 가지는 수자 하나를 가지면 되겠죠.
